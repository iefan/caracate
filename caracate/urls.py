...
urlpatterns = patterns('',
    ...
    url(r'^cc_delete/(\d+)/$', 'keepeyes.views.cc_delete'),
    url(r'^cc_delete_ok/(\d+)/$', 'keepeyes.views.cc_delete_ok'),
    ...
    url(r'^notcc_delete/(\d+)/$', 'keepeyes.views.notcc_delete'),
    url(r'^notcc_delete_ok/(\d+)/$', 'keepeyes.views.notcc_delete_ok'),
